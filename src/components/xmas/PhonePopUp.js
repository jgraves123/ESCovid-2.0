                            ...
                            <div className="card">
                                <div className="row g-0">
                                    <div className="col-12 col-lg-5 col-xl-3 border-right">
                                            ...
                                            <div className="d-flex align-items-start">
                                                ...
                                                <div className="flex-grow-1 ml-3">
                                                    ...
                                                    <div className="small"><span
                                                        className="fas fa-circle chat-online">Online</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                        <a href="#"
                                           className="list-group-item list-group-item-action border-0"
                                           onClick={this.changeConvo1}>
                                            <div className="badge bg-success float-right">3</div>
                                            <div className="d-flex align-items-start">
                                                <img src={this.avatars[1]}
                                                     className="rounded-circle mr-1"
                                                     alt="William Harris" width="40"
                                                     height="40"/>
                                                <div className="flex-grow-1 ml-3">
                                                    {this.chatNames[1]}
                                                    <div className="small"><span
                                                        className="fas fa-circle chat-offline">Offline</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                        <a href="#"
                                           className="list-group-item list-group-item-action border-0"
                                           onClick={this.changeConvo2}>
                                            <div className="d-flex align-items-start">
                                                <img src={this.avatars[2]}
                                                     className="rounded-circle mr-1"
                                                     alt="Vanessa Tucker" width="40"
                                                     height="40"/>
                                                <div className="flex-grow-1 ml-3">
                                                    {this.chatNames[2]}
                                                    <div className="small"><span
                                    ...
                                    <div className="col-12 col-lg-7 col-xl-9">
                                        ...
                                        {this.state.chat === 0 ?
                                            <div className="position-relative">
                                                <div className="chat-messages p-4">
                                                    <Text
                                                        character={this.chatNames[this.state.chat]}
                                                        timesent="2:34 am"
                                                        myavatar={this.avatars[this.state.chat]}>
                                                        Hey Sarah! Can you take the boys to practice
                                                        tomorrow?</Text>
                                                    <Text
                                                        character={this.chatNames[this.state.chat]}
                                                        timesent="2:34 am"
                                                    ...
                                                    <div className="chat-message-right pb-4">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                className="font-weight-bold mb-1">You
                                                            </div>
                                                            No problem!
                                                        </div>
                                                    </div>
                                        ...
                                        {this.state.chat === 1 ?
                                            <div className="position-relative">
                                                <div className="chat-messages p-4">
                                                    <Text character={this.chatNames[1]}
                                                          timesent="2:37 am"
                                                          myavatar={this.avatars[this.state.chat]}>
                                                    ...
                                                    {this.state.wrong === 1 ?
                                                        <div>
                                                            ...
                                                            <Text
                                                                character={this.chatNames[this.state.chat]}
                                                                timesent={this.state.hr + ":" + this.state.minute + "am"}
                                                                myavatar={this.avatars[this.state.chat]}>
                                                                Failed attempt. Deleting records for
                                                                security in 10 ... 9 ... 8...</Text>
                                                        </div>
                                                        : null
                                                    }
                                                </div>
                                                ...
                                                <div className="chat-messages p-4">
                                                    <div className="chat-message-right pb-4">
                                                        ...
                                                        <div
                                                            ...
                                                            SIBLING is asking me about his dad
                                                            again...idk what to tell him.
                                                        </div>
                                                    </div>
                                                    <Text character={this.chatNames[2]}
                                                          timesent="10:37 am"
                                                          myavatar={this.avatars[this.state.chat]}>
                                                        Have you tried changing the subject to his
                                                        grades?</Text>
                                                    <Text character={this.chatNames[2]}
                                                          timesent="10:37 am"
                                                          myavatar={this.avatars[this.state.chat]}>
                                                        Kidding. Not sure what to tell you. Be
                                                        honest with him? He's almost an adult
                                                        now...</Text>
                                                    <div className="chat-message-right pb-4">
                                                        <img
                                                            src="https://bootdey.com/img/Content/avatar/avatar3.png"
                                                    ...
                                                    <div className="chat-message-right pb-4">
                                                        ...
                                                        <div
                                                            ...
                                                            If I told him I found his dad's number
                                                            he'd want to meet him, I'm sure of it.
                                                            He's a tough kid, but you know how
                                                            obsessed he gets about things. I just
                                                            don't want him to be crushed if it turns
                                                            out his dad isn't thrilled to find out
                                                            he has a full grown child.
                                                        </div>
                                                    </div>
                                                    <div className="chat-message-right pb-4">
                                                        <img
                                                    ...
                                                    <Text character={this.chatNames[2]}
                                                          timesent="10:37 am"
                                                          myavatar={this.avatars[this.state.chat]}>
                                                        Don't beat yourself up Sal. () will
                                                        understand you did your best at the time.
                                                        And you don't have to tell him anything just
                                                        yet.</Text>
                                                    <div
